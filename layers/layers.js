...
maxResolution:2.8004466152261966,
    ...
    <img src="styles/legend/BoundaryProgressClearing_13_7.png" /> OTHER<br />'
        });
var format_GeotaggedPhotoWeb_14 = new ol.format.GeoJSON();
var features_GeotaggedPhotoWeb_14 = format_GeotaggedPhotoWeb_14.readFeatures(json_GeotaggedPhotoWeb_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GeotaggedPhotoWeb_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GeotaggedPhotoWeb_14.addFeatures(features_GeotaggedPhotoWeb_14);cluster_GeotaggedPhotoWeb_14 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_GeotaggedPhotoWeb_14
});
var lyr_GeotaggedPhotoWeb_14 = new ol.layer.Vector({
                declutter: false,
                source:cluster_GeotaggedPhotoWeb_14, 
                style: style_GeotaggedPhotoWeb_14,
                popuplayertitle: "Geotagged Photo Web",
                interactive: true,
                title: '<img src="styles/legend/GeotaggedPhotoWeb_14.png" /> Geotagged Photo Web'
            });
...
lyr_202411_survei_pohon_12.set('fieldAliases', {'no': 'no', 'nomor_bc': 'nomor_bc', 'jenis_poho': 'jenis_poho', 'diameter': 'diameter', 'tinggi': 'tinggi', 'volume': 'volume', });
lyr_BoundaryProgressClearing_13.set('fieldAliases', {'NO': 'NO', 'NAME': 'NAME', 'DATE': 'DATE', 'AREA': 'AREA', });
lyr_GeotaggedPhotoWeb_14.set('fieldAliases', {'photo': 'photo', 'altitude': 'altitude', 'direction': 'direction', 'rotation': 'rotation', 'longitude': 'longitude', 'latitude': 'latitude', 'timestamp': 'timestamp', });
...
lyr_202411_survei_pohon_12.set('fieldImages', {'no': 'TextEdit', 'nomor_bc': 'TextEdit', 'jenis_poho': 'TextEdit', 'diameter': 'TextEdit', 'tinggi': 'TextEdit', 'volume': 'TextEdit', });
lyr_BoundaryProgressClearing_13.set('fieldImages', {'NO': 'TextEdit', 'NAME': 'TextEdit', 'DATE': 'TextEdit', 'AREA': 'TextEdit', });
lyr_GeotaggedPhotoWeb_14.set('fieldImages', {'photo': 'ExternalResource', 'altitude': 'TextEdit', 'direction': 'TextEdit', 'rotation': 'TextEdit', 'longitude': 'TextEdit', 'latitude': 'TextEdit', 'timestamp': 'TextEdit', });
...
lyr_202411_survei_pohon_12.set('fieldLabels', {'no': 'inline label - always visible', 'nomor_bc': 'inline label - always visible', 'jenis_poho': 'inline label - always visible', 'diameter': 'inline label - always visible', 'tinggi': 'inline label - always visible', 'volume': 'inline label - always visible', });
...
lyr_GeotaggedPhotoWeb_14.set('fieldLabels', {'photo': 'inline label - always visible', 'altitude': 'inline label - always visible', 'direction': 'inline label - always visible', 'rotation': 'inline label - always visible', 'longitude': 'inline label - always visible', 'latitude': 'inline label - always visible', 'timestamp': 'inline label - always visible', });
lyr_GeotaggedPhotoWeb_14.on('precompose', function(evt) {
